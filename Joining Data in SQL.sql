...
-- It returns the data in both tables
...
-- It returns what not found in the other table
...
SELECT local_name, lang_num
  ...
  -- Where codes match
  WHERE lang_num.code = countries.code
